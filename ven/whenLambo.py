    ...
    try:
        ...
        for x in LongCoins:
            ...
            if float(exractCoin[1]) < currentPrice:
                ...
                sendUserTELEMsg(f"{current_time}:{newSymbol}: LONG SATTIM 0.50$ KAR\n Aldigim yer:{exractCoin[4]}\n Sattigim yer:{exractCoin[1]}\n Miktar:{exractCoin[2]}", underOptions[2], underOptions[3], underOptions[5], current_time)
        ...
        for y in ShortCoins:
            ...
            if float(exractCoin[1]) > currentPrice:
                ...
                sendUserTELEMsg(f"{current_time}:{newSymbol}: SHORT SATTIM 0.50$ KAR\n Aldigim yer:{exractCoin[4]}\n Sattigim yer:{exractCoin[1]}\n Miktar:{exractCoin[2]}", underOptions[2], underOptions[3], underOptions[5], current_time)
